FROM macropin/strider:1.7.5

MAINTAINER Andrew Cutler <andrew@panubo.io> 

ENV BUILD=2015110300 DOCKER_VERSION=1.6.2 DEPLOY_VENV_ROOT=/usr/local DEPLOY_USE_VENV=false FLEET_VERSION=v0.11.5 ETCD_VERSION=v2.0.12
